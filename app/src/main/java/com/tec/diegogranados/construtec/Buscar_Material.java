...
public class Buscar_Material extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buscar_material);
    ...
    private void Crear_List_Adapter(){
        listview = (ListView) findViewById(R.id.list_View_Buscar_Material);
    ...
    private void Agregar_Accion(ListView listview){
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                siguiente = new Intent(Buscar_Material.this, Info_Obra.class);
